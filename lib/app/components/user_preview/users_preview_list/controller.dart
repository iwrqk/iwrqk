...
import '../../../modules/search_result/controller.dart';
import '../../iwr_refresh/controller.dart';
import 'repository.dart';

class UsersPreviewListController extends IwrRefreshController<UserModel> {
  ...
  void initConfig(
    ...
    if (isSearch) {
      SearchResultController parentController = Get.find();
  ...
  Future<void> resetKeyword(String keyword) async {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      refreshData(showSplash: true).then((value) => null);
    });
  }
